...
describe('minercraft', () => {
   ...
   it('should post an existing transaction', async () => {
      const miner = new Minercraft({
         "url": "https://merchantapi.matterpool.io",
         headers: {
      ...
      let status = await miner.tx.push("")
      delete status.currentHighestBlockHash;
      delete status.currentHighestBlockHeight;
      delete status.timestamp;
      expect(status).to.eql({
         apiVersion: '0.1.0',
